...
description: >-
  ...
  methods, background, problem, comparisons, results, conclusions, limitations,
  and future outlook. Use this
...
Summarize an academic PDF paper into a structured Chinese report with 13 fields.
...
Go through the extracted text and fill in all 13 fields from the template.
...
### Limitations (本文缺陷)
- Identify the paper's self-acknowledged limitations (usually in Discussion or Conclusion section)
- Identify limitations not acknowledged by the authors but apparent from the experiments
  (e.g., limited scenarios, small scale, missing baselines, unrealistic assumptions)
- Categorize as: method limitations, experimental limitations, scope limitations

### Future Outlook (未来展望)
- The future work explicitly mentioned by the authors
- Additional improvement directions you can infer from the paper's limitations
- Potential research opportunities that this paper opens up

### Conclusions (论文的结论)
- The main takeaways from the paper
- Brief summary of conclusions only (detailed future work goes in Future Outlook)
